<div x-data="{ 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="aws-card p-6 bg-white shadow-sm border border-slate-200">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="w-full bg-slate-200 h-2"> <div class="bg-emerald-500 h-2 transition-all" :style="'width: ' + cashierPerformance.orderAccuracy + '%'"></div>
                    </div>
                </div>
                <div>
                    <div class="flex justify-between items-center mb-2">
                    ...
                    <div class="w-full bg-slate-200 h-2">
                        <div class="bg-blue-500 h-2 transition-all" :style="'width: ' + cashierPerformance.speedOfService + '%'"></div>
                    </div>
                </div>
                <div>
                    <div class="flex justify-between items-center mb-2">
                    ...
                    <div class="w-full bg-slate-200 h-2">
                        <div class="bg-pink-500 h-2 transition-all" :style="'width: ' + cashierPerformance.customerHandling + '%'"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="aws-card p-6 bg-white shadow-sm border border-slate-200">
            ...
            <div class="space-y-3 max-h-[300px] overflow-y-auto">
                <template x-for="activity in recentActivities" :key="activity.id">
                    <div class="p-3 bg-slate-50 border border-slate-200"> <div class="flex items-start justify-between">
                            <div>
                            ...
                            <span class="text-xs font-bold px-2 py-1 bg-emerald-100 text-emerald-700" x-text="activity.status"></span>
                        </div>
                    </div>
                </template>
            </div>

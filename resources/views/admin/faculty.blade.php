...
<head>
    ...
    <style>
        ...
        .aws-sidebar { width: 260px; background: white; border-right: 1px solid #eaeded; height: calc(100vh - 59px); position: fixed; top: 59px; left: 0; transition: all 0.3s ease; z-index: 1000; }
